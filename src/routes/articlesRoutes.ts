...
articlesRoute.post("/", userAuthorization(["Editor", "Journalist"]), isArticleAlreadyExists, multerConfig.array("images"), transformFilesToBody, bodyValidation(newArticleSchema), articlesControllers.createNewArticle);
